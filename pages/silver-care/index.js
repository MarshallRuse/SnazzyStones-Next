    ...
    return (
        <>
            ...
            <section className='px-10 md:px-40 py-20 bg-blueyonder-500 grid md:grid-cols-5 gap-x-20 items-center'>
                ...
                <div className='text-white md:col-span-3 md:order-2'>
                ...
                <figure className='md:col-span-2 md:order-1'>
                    <div className='flex rounded-md shadow-light'>
                        <Image
                    ...
                    <figcaption className='text-white text-center mt-4'>Our top tip: wear your jewellery!</figcaption>
                </figure>
            </section>
                ...
                <div className='text-blueyonder-500'>
                    ...
                    <ul className='snazzyList blueList text-blueyonder-400'>
                        <li>
                            ...
                            <strong className='text-blueyonder-500'>a polishing cloth</strong> is just what you need to
                            bring the shine back to your piece! These are generally a microfiber cloth or a lint-free
                            flannel with a cleaning agent on one side (Snazzy Stones offers both these options!). We
                            recommend these types of cloths or another nonabrasive type (avoid items such as paper
                            towels) because sterling silver is so soft, it can easily be scratched from fibers in the
                            material you are using.
                        </li>
                        <li>
                            There are a lot of{" "}
                            <strong className='text-blueyonder-500'>sterling silver dips and polishes</strong> that work
                            well in cleaning your items, which can be found at hardware stores. We recommend using them
                            in a well ventilated area, looking into proper disposal methods, and avoid using them for
                            any product with natural stones in it, especially soft, porous stones like pearls, amber, or
                            turquoise. (We are currently working on finding an effective, green polish option for you
                            that works well and keeps you and our planet safe – stay tuned)!
                        </li>
                        <li>
                            ...
                            <ul className='snazzySubList'>
                                <li>
                                    Place some aluminum foil on the bottom of a small pot or bowl, shiny side up with
                                    your piece of sterling silver sitting on top.
                                </li>
                                <li>Cover the jewellery with boiling hot water.</li>
                                <li>
                                    Add around 2 tbsp each of salt and baking soda (or washing soda we find works even
                                    better!)
                                </li>
                                <li>Mix to dissolve the solution and leave it for 5-10 minutes to work its magic.</li>
                                <li>
                                    For chains we like to scrub with a <em>soft</em> toothbrush while in the mixture to
                        ...
                        <li>
                            You may have heard before that using toothpaste is also an option for cleaning your sterling
                            silver jewellery. While this is true, the toothpaste this is referring to is{" "}
                            <strong className='text-blueyonder-500'>
                                non-whitening, non-gel, basic (and getting harder to come by) toothpaste.
                            </strong>{" "}
                            An alternative to this is using a clean, soft cloth (remember, silver is easily scratched if
                            the cloth is too abrasive) and applying a{" "}
                            <strong className='text-blueyonder-500'>
                                small amount of paste made from baking soda and water
                            </strong>{" "}
                            to your piece. If the piece has any indentations, add more water to dilute the paste so it
                            doesn’t stick and dry in the cracks. Rinse and buff with a soft cloth!
                        </li>
                        <li>
                            Our last option is ignoring these four prior tips and bringing your sterling silver in to{" "}
                            <strong className='text-blueyonder-500'>get it professionally cleaned</strong> (and
                            promising you will follow the preventative measures next time!). Pop by your local jewelers
