...
export default function PrivacyPolicy() {
    return (
        <div className='text-blueyonder-500 p-10 max-w-screen-lg mx-auto'>
            <h1>Privacy Policy</h1>
            <p className='text-sm'>
                <em>Last updated: December 13, 2020</em>
            </p>
            <p>Snazzy Stones (“us”, “we”, or “our”) operates the snazzystones.ca website (the “Service”).</p>
            <p>
            ...
            <p>
                ...
                <Link href='/index'>
                    <a className='text-bluegreen-500'>Terms and Conditions</a>
                </Link>
                .
            </p>
            ...
            <p>
                ...
                contact us. If we discover that a child under 18 has provided us with Personal Information, we will
