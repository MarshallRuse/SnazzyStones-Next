...
import type { APIProductsResponse } from "@/app/api/retail/products/route";
...
export default function SiteSearch({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: Closes autocomplete on path change
	useEffect(() => {
